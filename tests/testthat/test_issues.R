...
my_project <- gl_project_connection(test_url,
                                    ...
                                    api_version = test_api_version)
# create an issue
new_issue <- my_gitlab(gl_create_issue, "A simple issue", project = test_project)
...
test_that("getting issues works", {
  ...
  expect_is(my_gitlab(gl_list_issues, test_project, 2, force_api_v3 = (test_api_version == "v3")), "data.frame")
  expect_is(my_gitlab(gl_get_issue, new_issue$id[1], test_project, force_api_v3 = (test_api_version == "v3")), "data.frame")
  expect_equivalent(my_gitlab(gl_get_issue, new_issue$id[1], test_project, force_api_v3 = (test_api_version == "v3")),
                    my_gitlab(gl_list_issues, test_project, new_issue$id[1], force_api_v3 = (test_api_version == "v3")),
                    "data.frame")
...
test_that("editing issues works", {
  ...
  ## close issue
  my_gitlab(gl_close_issue, new_issue$id[1], test_project, force_api_v3 = (test_api_version == "v3"))
  expect_true(my_gitlab(gl_list_issues, test_project, new_issue$id[1], force_api_v3 = (test_api_version == "v3"))$state == "closed")
  
  ## reopen issue
  my_gitlab(gl_reopen_issue, new_issue$id[1], test_project, force_api_v3 = (test_api_version == "v3"))
  expect_true(my_gitlab(gl_list_issues, test_project, new_issue$id[1], force_api_v3 = (test_api_version == "v3"))$state == "opened")
  
  ## edit its description
  my_gitlab(gl_edit_issue, new_issue$id[1], test_project, description = "This is a test", force_api_v3 = (test_api_version == "v3"))
  expect_true(my_gitlab(gl_list_issues, test_project, new_issue$id[1], force_api_v3 = (test_api_version == "v3"))$description == "This is a test")
  my_gitlab(gl_edit_issue, new_issue$id[1], test_project, description = "This is not a test", force_api_v3 = (test_api_version == "v3"))
  expect_false(my_gitlab(gl_list_issues, test_project, new_issue$id[1], force_api_v3 = (test_api_version == "v3"))$description == "This is a test")
  
  test_user <- new_issue$author.name[1]
  
  ## assign it
  my_gitlab(gl_assign_issue, new_issue$id[1], assignee_id = 2, test_project, force_api_v3 = (test_api_version == "v3"))
  expect_true(my_gitlab(gl_list_issues, test_project, new_issue$id[1], force_api_v3 = (test_api_version == "v3"))$assignee.username == test_user)
  my_gitlab(gl_unassign_issue, new_issue$id[1], test_project, force_api_v3 = (test_api_version == "v3"))
  expect_null(my_gitlab(gl_list_issues, test_project, new_issue$id[1], force_api_v3 = (test_api_version == "v3"))$assignee.username)

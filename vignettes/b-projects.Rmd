...
This code is the one you can run with an account on <https://gitlab.com> to be able to contribute to {gitlabr} and set a testing environment (See [CONTRIBUTING.md](https://github.com/statnmap/gitlabr/blob/main/CONTRIBUTING.md).

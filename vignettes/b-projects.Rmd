...
Given you have a [GitLab.com](https://about.gitlab.com/) account, this code can also be run to contribute to {gitlabr} and set a testing environment (See [CONTRIBUTING.md](https://github.com/statnmap/gitlabr/blob/main/CONTRIBUTING.md)).

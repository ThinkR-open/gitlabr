...
- The output of every call to a `gitlabr` function is a `data_frame` to integrate seamless into dplyr's data manipulation mindset (often called the "tidyverse")

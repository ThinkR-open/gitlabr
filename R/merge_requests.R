...
#' )
#' # List all opened MR
#' gl_list_merge_requests(project = "test_project_id", status = "opened")
#' # Edit MR created
#' gl_edit_merge_request(
#'   project = "test_project_id", merge_request_iid = mr_infos$iid,
#'   assignee_id = "<<user-id>>"
#' )
#' # Close MR
#' gl_close_merge_request(project = "test_project_id", merge_request_iid = mr_infos$iid)
#' # Delete MR as it never existed
#' gl_delete_merge_request(project = "test_project_id", merge_request_iid = mr_infos$iid)
#' }

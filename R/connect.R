...
#' @param private_token private_token with which to identify.
#' You can generate one in the web interface under
#' `GITLABINSTANCEURL/-/profile/personal_access_tokens.html` when logged on.
#' @param api_version Currently "4" for the latest GitLab API version.
...
#' "v4" is the standard API since GitLab version 9.0
